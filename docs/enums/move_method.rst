...
.. table:: Сравнение методов
   ...
   +============+======+===========+========+=========================================================+
   | **append** | ❌   | ❌        | ❌     | Инкрементальная загрузка данных                        |
   +------------+------+-----------+--------+---------------------------------------------------------+
   | **delete** | ✅   | ✅        | ❌     | Удаление старых записей по фильтрующим колонкам        |
   +------------+------+-----------+--------+---------------------------------------------------------+
   | **replace**| ✅   | ❌        | ❌     | Замена партиций (только для партиционированных таблиц) |
   +------------+------+-----------+--------+---------------------------------------------------------+
   | **rewrite**| ❌   | ❌        | ❌     | Полная перезапись таблицы                              |
   +------------+------+-----------+--------+---------------------------------------------------------+
   | **custom** | ❌   | ❌        | ✅     | Удаление на основе пользовательского запроса           |
   +------------+------+-----------+--------+---------------------------------------------------------+
