...
- :doc:`../methods/to_reader` - Чтение данных из ClickHouse в виде объекта NativeReader
- :doc:`query_formatter` - Форматирование и нормализация SQL-запросов для ClickHouse
