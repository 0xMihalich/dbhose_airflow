...
``NativeReader`` реализует интерфейс файлового объекта и может использоваться
в любом контексте, где требуется потоковое чтение бинарных данных.
...
- :doc:`read_dump` - Чтение данных в файл
- :doc:`write_dump` - Запись данных из файла
